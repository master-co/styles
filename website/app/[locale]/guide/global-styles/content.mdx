    ...
    <div className="grid-cols:2 gap:20">
        <div>
            ...
            <div className="mt:10 b:1|crimson-40 square overflow:hidden">
                <Image src={require('~/website/public/images/chicken.png').default} width={500} height={500} alt="No responsive image" className="max-w:none" />
            </div>
        </div>
        <div>
            <small>After</small>
            <div className="mt:10 b:1|green-40 square">
                <Image src={require('~/website/public/images/chicken.png').default} width={500} height={500} alt="Responsive image" />
            </div>
        </div>
    </div>
</Demo>
