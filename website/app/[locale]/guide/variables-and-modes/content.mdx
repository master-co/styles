...
One of the most significant ways of managing sources of truth is through design tokens. In Master CSS, you can implement your design tokens through [configuration](/reference/configuration).
...
## Future
- A plugin to convert Figma's variables to [Master CSS's configuration](/reference/configuration).