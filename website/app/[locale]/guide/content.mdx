...
<OverviewButtons>
    {guideCategories.find(category => category.name === 'Development Strategy').pages}
</OverviewButtons>
...
<Image className="r:2x max-w:screen-xs w:full" src={require('~/public/images/play.png').default} alt="Master CSS Play" placeholder="blur" />
