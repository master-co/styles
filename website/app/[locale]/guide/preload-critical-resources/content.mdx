...
<Image src={require('~/website/public/images/no-preload-network.png')} placeholder="blur" alt="Screenshot of Chrome DevTools Network panel" width="841" height="69" />
...
<Image src={require('~/website/public/images/preload-network.png')} placeholder="blur" alt="Screenshot of Chrome DevTools Network panel" width="841" height="69" />
