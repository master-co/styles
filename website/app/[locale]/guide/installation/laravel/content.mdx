...
<RuntimeRenderingIntro img={{
    ...require('~/website/public/images/laravel-dev.png').default,
    dark: require('~/website/public/images/laravel-dev@dark.png').default,
...
<StepSection>
    ...
    <Step $row>
        <StepL>
            ...
            - Add `css display: none` to `html <html>` to [avoid FOUC](/guide/flash-of-unstyled-content)
        </StepL>
        <StepR>
