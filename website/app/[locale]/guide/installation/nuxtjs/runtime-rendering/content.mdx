...
<RuntimeRenderingIntro img={{
    href: "https://nuxtjs.rr.rc.css.master.co",
    ...require('~/website/public/images/nuxtjs-dev.png').default,
    dark: require('~/website/public/images/nuxtjs-dev@dark.png').default,
...
<StepSection>
    <Step $row>
        ...
        <StepR>
            ```bash name=Terminal
            npm create @master/css@rc __project__ --example nuxt.js-with-runtime-rendering
            cd __project__
            npm run dev
            ```
        </StepR>
