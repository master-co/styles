...
<StaticExtractionIntro img={{
    href: "https://svelte.se.rc.css.master.co",
    ...require('~/website/public/images/svelte-dev.png').default,
    dark: require('~/website/public/images/svelte-dev@dark.png').default,
...
<StepSection>
    <Step $row>
        <StepL>
            ...
            Copy-paste the commands to quickly start using the https://svelte.se.rc.css.master.co example.

            You can skip all [installation](#installation) steps.
        </StepL>
        <StepR>
            ```bash name=Terminal
            npm create @master/css@rc __project__ --example svelte-with-static-extraction
            cd __project__
            npm run dev
            ```
        </StepR>
