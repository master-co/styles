...
We've predefined [practical units and conversion behavior](/reference/rules#default-reference) based on the characteristics of different style properties, and most of them involve converting from `px` to `rem`.
