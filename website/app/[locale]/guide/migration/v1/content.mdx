...
```
To learn more, check out those documents: [Colors](/reference/colors), [Fonts](/reference/fonts), [Screen Sizes](/reference/screen-sizes), [Spacing & Sizing](/reference/spacing-and-sizing), [Variables](/reference/variables)

### Using new custom animations
In v2, you can apply the [default animations](/reference/animations) out of the box:
```html
...
```
To customize keyframes, check out the [Animations](/reference/animations) documentation.
...
```
To learn more, check out the [Styles](/reference/styles) documentation.

### Merging media queries
Deprecate extended `breakpoints` and `queries` ​​in favor of `config.queries`.
```js name=master.css.js
-import { Style } from '@master/css'
...
+}
```
To learn more, check out the [Queries](/reference/queries) documentation.
