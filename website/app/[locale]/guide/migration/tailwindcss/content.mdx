...
## 🚧 Configuration
### Customizing screens
Define responsive breakpoints using [queries](/reference/queries).
...
Using [queries](/reference/queries) to define media queries, feature queries, and even container queries.
```js name=master.css.js
-/** @type {import('tailwindcss').Config} */
-module.exports = {
-    theme: {
