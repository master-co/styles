...
<Image className="aspect:2/1 r:2x max-w:screen-xs w:full" src={require('~/website/public/syntax-error-checks.webp').default} alt="Syntax error checks" unoptimized />
...
<figure>
    <Image src={require('~/website/public/colors.svg').default} className="r:2x" alt="Master Colors" />
...
<figure>
    <Image src={require('~/website/public/master-colors-motivation.jpg').default} className="r:2x" alt="Master Colors Motivation" />
</figure>
...
The protagonist of v2 is here - a brand-new [configuration API](/reference/configuration) designed specifically for design systems. For keeping a fresh feeling of what's released, please refer to the documentation first.
...
<figure>
    <Image src={require('~/website/public/theme-modes.webp').default} className="r:2x" alt="Master Theme Modes" unoptimized />
...
<figure>
    <Image src={require('~/website/public/master-ui-covers.jpeg').default} className="r:2x" alt="Master UI" />
...
(i) D. Import all Master UI [styles](/reference/styles) in the configuration.
...
Major tasks will be completed before the v2 release; minor tasks like extensive use cases of CSS properties will be filled in our future day-to-day work. Here's an example, [`text-transform`](/reference/text-transform)：
<Demo $py={0}>
    <DemoPanel>
...
<details>
    ...
    <div className='bg:canvas b:1|frame p:3x|8x r:1x mt:2x'>
        The official [documentation is now open source](https://github.com/master-co/css/tree/rc/website/app/%5Blocale%5D//docs); welcome to contribute your expertise.
    </div>
</details>

---

<StarUs />~/website/app/version