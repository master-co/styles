import SyntaxesOverview from '../syntaxes/components/Overview.mdx'
...
import AtOverview from '../at/components/Overview.mdx'
...
## Options
### `.animations`
Customizing animation [animations](/reference/animations) for your design system.
<KeyframesOverview />

### `.functions`
Customizing [functions](/reference/functions) for your design system.
<FunctionsOverview />

### `.at`
Customizing [at](/reference/at) for your design system.
<AtOverview />

### `.syntaxes`
Customizing [syntaxes](/reference/syntaxes) for your design system.
<SyntaxesOverview />

### `.selectors`
Customizing [selectors](/reference/selectors) for your design system.
<SelectorsOverview />
...
### `.styles`
Customizing abstract [styles](/reference/styles) for your design system.
<StylesOverview />
...
../syntaxes/components/Overview.mdx