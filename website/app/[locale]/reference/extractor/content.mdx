...
### `options.config`
Customize your Master CSS [configuration](/reference/configuration) or the path to the configuration file, the default configuration file is read with [.cwd](#cwd) in the root directory of the project.
