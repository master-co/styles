...
```html
<div class="hidden@<sm text:center@sm aspect:2/1@landscape">…</div>
```
...
### Default
<Default />
View the full [source code](https://github.com/master-co/css/blob/rc/packages/core/src/config/queries.ts)
