    ...
    return (
        <RootLayout bodyClassName='bg:base' locale={locale} translations={await importTranslations(locale)} style={{ display: 'none' }}>
            ...
            <div className="center-content flex flex:col min-h:100dvh pt:50 pt:60@md px:10x">
                <h3 className='fg:accent font:18 tracking:.01em mb:5x mt:12x text:center'>404</h3>
                <h1 className='fg:strong font:32 font:48@sm font:extrabold leading:1.2 tracking:-.4 mt:0 text:center'>{$('This page does not exist')}</h1>
                <div className='mb:12x p:4x|2x'>
                    ...
                    <SearchButton className="flex align-items:center fg:lightest rounded b:1|frame leading:3rem min-w:60x mt:10x mx:auto pointer-events:auto px:6x" />
                </div>
            </div>
        </RootLayout>
    )
