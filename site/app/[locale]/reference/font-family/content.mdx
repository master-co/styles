...
```
In practice, you wouldn't arbitrarily set the font family within the template; instead, you would unify your fonts through [custom variables](/guide/custom-variables#add-fonts).
...
(o) Predefine your [font](/guide/custom-variables#add-fonts) variables without `\00a0`.
...
## Customization
Check out the [custom variables](/guide/custom-variables#add-fonts).