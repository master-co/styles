...
We provide a **~600B** lightweight CSS package, [@master/normal.css](https://github.com/master-co/normal.css), is similar to [modern-normalize](https://github.com/sindresorhus/modern-normalize) and [normalize.css](https://github.com/necolas/normalize.css) you are familiar with but better:
...
<Code lang="css">
{require('!!raw-loader!@master/normal.css/consistent-abbreviation-styles.css?text').default}
</Code>

### Consistent control styles
Fixed the inconsistent appearance of controls across browsers.
<Code lang="css">
{require('!!raw-loader!@master/normal.css/consistent-control-styles.css?text').default}
</Code>
...
<Code lang="css">
{require('!!raw-loader!@master/normal.css/consistent-horizontal-lines.css?text').default}
</Code>

### Consistent bold styles
Fixed the inconsistent font weight of `html <b>` and `html <strong>` across browsers.
<Code lang="css">
{require('!!raw-loader!@master/normal.css/consistent-bold-styles.css?text').default}
</Code>

### Consistent code styles
Fixed the inconsistent font size of code-related elements across browsers.
<Code lang="css">
{require('!!raw-loader!@master/normal.css/consistent-code-styles.css?text').default}
</Code>

### Consistent small styles
Fixed the inconsistent font size of `html <small>` across browsers.
<Code lang="css">
{require('!!raw-loader!@master/normal.css/consistent-small-styles.css?text').default}
</Code>
...
<Code lang="css">
{require('!!raw-loader!@master/normal.css/consistent-superscript-subscript.css?text').default}
</Code>

### Consistent table styles
Fixed the inconsistent appearance of tables across browsers.
<Code lang="css">
{require('!!raw-loader!@master/normal.css/consistent-table-styles.css?text').default}
</Code>
...
<Code lang="css">
{require('!!raw-loader!@master/normal.css/intuitive-sizing-control.css?text').default}
</Code>
...
<Code lang="css">
{require('!!raw-loader!@master/normal.css/remove-anchor-styles.css?text').default}
</Code>
...
<Code lang="css">
{require('!!raw-loader!@master/normal.css/remove-control-styles.css?text').default}
</Code>
...
<Code lang="css">
{require('!!raw-loader!@master/normal.css/remove-default-borders.css?text').default}
</Code>
...
<Code lang="css">
{require('!!raw-loader!@master/normal.css/remove-default-spacing.css?text').default}
</Code>
...
<Code lang="css">
{require('!!raw-loader!@master/normal.css/eliminate-click-delays.css?text').default}
</Code>
...
<Code lang="css">
{require('!!raw-loader!@master/normal.css/better-text-appearance.css?text').default}
</Code>

### Readable tab size
Setting the tab size to 4 makes the code more structured and easier to read.
<Code lang="css">
{require('!!raw-loader!@master/normal.css/readable-tab-size.css?text').default}
</Code>
...
<Code lang="css">
{require('!!raw-loader!@master/normal.css/responsive-media-elements.css?text').default}
</Code>
