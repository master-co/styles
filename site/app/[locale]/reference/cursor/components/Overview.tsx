                ...
                {syntaxes.map((syntax) =>
                    <SyntaxTr value={syntax} key={syntax} previewSyntax={previewSyntax}>
                        {typeof syntax === 'string' && {
                            ...
                            'cursor:vertical-text': <IconCursorText className={clsx('inline-block mr:2x rotate(90) size:1.25em stroke:1.5 v:middle', syntax)} />,
                            ...
                            'cursor:row-resize': <IconArrowBarBoth className={clsx('inline-block mr:2x rotate(90) size:1.25em stroke:1.5 v:middle', syntax)} />,
                            ...
                            'cursor:nesw-resize': <IconArrowsHorizontal className={clsx('inline-block mr:2x rotate(-45) size:1.25em stroke:1.5 v:middle', syntax)} />,
                            'cursor:nwse-resize': <IconArrowsHorizontal className={clsx('inline-block mr:2x rotate(45) size:1.25em stroke:1.5 v:middle', syntax)} />,
