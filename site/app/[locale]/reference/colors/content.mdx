...
## Basic usage
### Use default colors
The official default color palette is [Master Colors](https://github.com/master-co/colors). Each color comes with a hue scale ranging from `5` to `95`, which you can directly apply through the related syntax:
```html
