...
## Customization
import AnimationsOverview from '~/site/app/[locale]/guide/configuration/components/AnimationsOverview.mdx'

### Add your animations
Customize your CSS animations using the [animations](/guide/configuration#animations) configuration.
<AnimationsOverview />