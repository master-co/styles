import { buttonSizes } from '~/site/styles/btn'
...
1. [Variables](/guide/custom-variables) / [Animations](/guide/custom-animations) / [Functions](/reference/custom-syntax#functions) / [Selectors](/reference/custom-syntax#selectors) / [At](/reference/custom-syntax#at-rules) / [Utilities](/reference/utilities)
