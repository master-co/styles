...
Assuming the card can be reused, you can abstract it using [styles](/guide/custom-styles) with a concise syntax:
...
<div class="block">
```
It can be [stateful and selectable](/reference/custom-syntax#selectors):
```html
