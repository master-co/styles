...
Assuming the card can be reused, you can abstract it using [styles](/guide/styles) with a concise syntax:
...
<div class="block">
```
It can be [stateful and selectable](/reference/syntaxes#selectors):
```html
