### Overview [sr-only]
Traditionally, we define styles like `.btn` or `.card` by writing CSS rules. In Master CSS, we use `config.styles` to abstract and make them more flexible.
<Code lang="js" name="master.css.js">{require('./tests/apply-styles/master.css.js?text').default}</Code>
...
You can even conditionally apply abstract styles via at-rules and selectors:
<Code lang="html">{require('./tests/apply-styles/template.html?text').default}</Code>
<details>
    <summary>Generated CSS</summary>
    <div>
        <Code lang="css" beautify>{require('./tests/apply-styles/generated.css?text').default}</Code>
    </div>
</details>
...
<details>
    <summary>Generated CSS</summary>
    <div>
        <Code lang="css" beautify>{require('!!raw-loader!./tests/add-a-style-with-states/generated.css?text').default}</Code>
    </div>
</details>
...
<details>
    <summary>Generated CSS</summary>
    <div>
        <Code lang="css" beautify>{require('!!raw-loader!./tests/add-styles-in-a-nested-structure/generated.css?text').default}</Code>
    </div>
</details>
...
<details>
    <summary>Generated CSS</summary>
    <div>
        <Code lang="css" beautify>{require('!!raw-loader!./tests/extend-an-existing-style/generated.css?text').default}</Code>
    </div>
</details>