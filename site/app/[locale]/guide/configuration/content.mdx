import SyntaxesOverview from '~/site/app/[locale]/guide/syntaxes/components/SyntaxesOverview.mdx'
import VariablesOverview from '~/site/app/[locale]/guide/variables/components/Overview.mdx'
import UtilitiesOverview from '~/site/app/[locale]/reference/utilities/components/Overview.mdx'
import AnimationsOverview from '~/site/app/[locale]/reference/animations/components/Overview.mdx'
import AtOverview from '~/site/app/[locale]/guide/syntaxes/components/AtOverview.mdx'
import SelectorsOverview from '~/site/app/[locale]/guide/syntaxes/components/SelectorsOverview.mdx'
import FunctionsOverview from '~/site/app/[locale]/guide/syntaxes/components/FunctionsOverview.mdx'
import StylesOverview from '~/site/app/[locale]/guide/styles/components/Overview.mdx'
...
## Options
### `.animations`
Customizing animation [animations](/guide/custom-animations) for your design system.
<AnimationsOverview />

### `.functions`
Customizing [functions](/reference/syntaxes#functions) for your design system.
<FunctionsOverview />

### `.at`
Customizing [at-rules](/reference/syntaxes#at-rules) for your design system.
<AtOverview />

### `.syntaxes`
Customizing [syntaxes](/reference/syntaxes#syntaxes) for your design system.
<SyntaxesOverview />

### `.selectors`
Customizing [selectors](/reference/syntaxes#selectors) for your design system.
<SelectorsOverview />
...
### `.styles`
Customizing abstract [styles](/guide/styles) for your design system.
<StylesOverview />
...
```../../guide/styles/components/Overview.mdx~/site/app/[locale]/guide/using-variables/components/Overview.mdx~/site/app/[locale]/guide/styles/components/Overview.mdx~/site/app/[locale]/guide/syntaxes/components/AtOverview.mdx~/site/app/[locale]/guide/syntaxes/components/SelectorsOverview.mdx~/site/app/[locale]/guide/syntaxes/components/FunctionsOverview.mdx~/site/app/[locale]/guide/variables/animations/components/Overview.mdx~/site/app/[locale]/guide/utilities/components/Overview.mdx