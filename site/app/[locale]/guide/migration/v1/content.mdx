...
```
To learn more, check out the [custom variables](/guide/custom-variables).

### Using new custom animations
In v2, you can apply the [default animations](/guide/custom-animations) out of the box:
```html
...
```
To customize keyframes, check out the [Animations](/guide/custom-animations) documentation.
...
```
To learn more, check out the [Styles](/guide/custom-styles) documentation.
...
+}
```
To learn more, check out the [at-rules](/reference/custom-syntax#at-rules) documentation.
