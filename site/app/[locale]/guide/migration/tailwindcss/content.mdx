...
```
Not just media queries but feature queries and [more](/reference/syntaxes).
...
### Add media queries
Using [at-rules](/reference/syntaxes#at-rules) to define media queries, feature queries, and even container queries.
```js name=master.css.js
-/** @type {import('tailwindcss').Config} */
-module.exports = {
-    theme: {
...
Use [styles](/guide/styles) to abstract styles instead of `@apply`.
```css name=main.css
- @tailwind base;
- @tailwind components;
- @tailwind utilities;
