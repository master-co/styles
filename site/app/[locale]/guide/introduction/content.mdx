...
Master CSS provides a set of systematic [configuration](/guide/configuration) APIs to help you build a consistent, easy-to-manage, and scalable design system:
