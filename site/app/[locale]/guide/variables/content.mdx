## Overview [sr-only]
In Master CSS, variables are used to manage tokens in the design system, such as [colors](/guide/colors), font families, breakpoints, etc., even based on different theme modes.
<Overview />
