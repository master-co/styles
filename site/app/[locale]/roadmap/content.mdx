...
<figure>
    <Image src={require('~/site/public/colors.svg').default} className="r:2x" alt="Master Colors" />
...
(i) D. Import all Master UI [styles](/guide/custom-styles) in the configuration.
...
- [ ] Major － Completing Getting Started, Tutorial, Fundamentals, etc., core documentation.
