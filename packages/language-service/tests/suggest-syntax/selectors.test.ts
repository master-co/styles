    ...
    test.concurrent('info', () => expect(hint('block:')?.find(({ label }) => label === ':first')).toEqual({
        ...
        'documentation': {
            ...
            'value': dedent`
                ...
                [Master CSS](https://rc.css.master.co/reference/selectors) | [MDN Reference](https://developer.mozilla.org/docs/Web/CSS/:first-child)
            `,
        },
        'insertText': 'first',
        'kind': 3,
    ...
    test.concurrent('info', () => expect(hint('block::')?.find(({ label }) => label === '::placeholder')).toEqual({
        ...
        'documentation': {
            ...
            'value': dedent`\`\`\`css
                ...
                [Master CSS](https://rc.css.master.co/reference/selectors) | [MDN Reference](https://developer.mozilla.org/docs/Web/CSS/::placeholder)
         `,
        },
