...
test.concurrent('number with themes', () => {
    expectLayers(
        {
            utility: '.m\\:x1{margin:calc(var(--spacing-x1) / 16 * 1rem)}',
    ...
    expectLayers(
        {
            utility: '.line-height\\:x1{line-height:var(--line-height-x1)}',
...
test.concurrent('number using variable function', () => {
    expectLayers(
        {
            utility: '.m\\:\\$\\(spacing-x1\\){margin:1rem}'
        },
        'm:$(spacing-x1)',
        {
            variables: {
...
test.concurrent('number with themes using variable function', () => {
    expectLayers(
        {
            utility: '.m\\:\\$\\(spacing-x1\\){margin:calc(var(--spacing-x1) / 16 * 1rem)}',
            theme: ':root{--spacing-x1:16}.dark{--spacing-x1:32}.light{--spacing-x1:48}'
        },
        'm:$(spacing-x1)',
        {
    ...
    expectLayers(
        {
            utility: '.line-height\\:\\$\\(spacing-x1\\){line-height:var(--spacing-x1)}',
            theme: ':root{--spacing-x1:16}.dark{--spacing-x1:32}.light{--spacing-x1:48}'
        },
