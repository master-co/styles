...
test('colors', () => {
    ...
    expect(new MasterCSS(config).add('fg:primary-stage-1').text)
        .toBe(':root{--primary-stage-1:255 255 255}.light{--primary-stage-1:0 0 0}.dark{--primary-stage-1:255 255 255}.fg\\:primary-stage-1{color:rgb(var(--primary-stage-1))}')
    ...
    expect(new MasterCSS(config).add('bg:linear-gradient(180deg,major,black)').text)
        .toBe('.light{--major:0 0 0}.dark{--major:255 255 255}.bg\\:linear-gradient\\(180deg\\,major\\,black\\){background-image:linear-gradient(180deg,rgb(var(--major)),rgb(0 0 0))}')
    ...
    expect(new MasterCSS({
        ...
        .toBe(':root{--primary-filled:0 0 0}.light{--primary-filled:255 255 255}.dark{--primary-filled:0 0 0}.bg\\:primary-filled,.btn{background-color:rgb(var(--primary-filled))}')
    ...
    expect(new MasterCSS(config).add('bg:code').text)
        .toBe('.light{--code:0 0 0}.dark{--code:255 255 255}.bg\\:code{background-color:rgb(var(--code))}')

    expect(new MasterCSS(config).add('bg:code/.5').text)
        .toBe('.light{--code:0 0 0}.dark{--code:255 255 255}.bg\\:code\\/\\.5{background-color:rgb(var(--code)/.5)}')

    expect(new MasterCSS(config).add('bg:fade-light').text)
        .toBe('.light{--fade-light:0 0 0}.bg\\:fade-light{background-color:rgb(var(--fade-light))}')
